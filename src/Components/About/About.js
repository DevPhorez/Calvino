	...
	return (
		<section className='position-relative' style={ { paddingBottom: 120 } }>
			<div className="container">
				<div className="row">
					<div className='order-1 offset-xxl-1 col-xxl-5 col-xl-6 col-lg-6 col-md-12 section-title mb-0 text-lg-start text-center' style={ { marginTop: '5rem' } }>
					...
					<div className='order-0 col-xxl-5 col-xl-6 col-lg-6 col-md-12' data-aos='fade-right'>
						<div className="about">
